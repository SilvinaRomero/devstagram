...
@endsection
@section('titulo')
    Crea una nueva publicación en <span class="devstagram">DevStagram</span>
@endsection
            ...
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <textarea id="descripcion" name="descripcion" type="text" placeholder="Descripción de la Publicación"
                        class="border p-3 w-full rounded-lg @error('descripcion') border-red-500 @enderror" value="">{{ old('descripcion') }}</textarea>
